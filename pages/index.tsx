...
const index = () => {
  return (
    <div className='flex flex-col flex-grow px-6 py-1'>
      ...
      <div className='flex-grow p-4 mt-3 mb-3 bg-gradient-to-br from-green-200 to-blue-200 rounded-3xl' style={{marginLeft: '-1rem', marginRight: '-1rem'}}>

        <h6 className='my-3 text-xl font-bold tracking-wide' >Services offered</h6>

        <div className='grid gap-6 lg:grid-cols-2'>
          {services.map((service, index) => (
            <div className='p-4 bg-gray-200 rounded-lg lg:col-span-1 '>
