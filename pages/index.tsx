...
const index = () => {
  return (
    <div className='flex flex-col flex-grow px-6 py-1'>
      ...
      <div className='flex-grow p-4 mt-3 mb-3 bg-gradient-to-br from-green-200 to-blue-200 rounded-3xl dark:bg-dark-300' style={{marginLeft: '-1rem', marginRight: '-1rem'}}>
